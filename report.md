...
Работа оценивает потенциал DC/IP для двух типичных рудных моделей и глубинного
каротажа сопротивления для частного нефтегазового случая. Для контролируемых синтетических данных
